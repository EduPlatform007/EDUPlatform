...
window.htmlCssKzQuizPractice[1] = {
...
window.htmlCssKzQuizPractice[2] = {
  // Тест для урока 2
  quizQuestions: [
    {
...
window.htmlCssKzQuizPractice[3] = {
...
window.htmlCssKzQuizPractice[4] = {
  // Тест для урока 4
  quizQuestions: [
    {
...
window.htmlCssKzQuizPractice[5] = {
...
window.htmlCssKzQuizPractice[6] = {
  // Тест для урока 6
  quizQuestions: [
    {
...
window.htmlCssKzQuizPractice[7] = {
...
window.htmlCssKzQuizPractice[8] = {
  // Тест для урока 8
  quizQuestions: [
    {
...
window.htmlCssKzQuizPractice[9] = {
...
// Глобальный объект с тестами и практическими заданиями инициализирован в начале файла
// Каждый урок добавлен в объект window.htmlCssKzQuizPractice
